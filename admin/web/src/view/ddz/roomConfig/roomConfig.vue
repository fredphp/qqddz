<template>
  <div>
    ...
    <!-- 编辑对话框 -->
    <el-dialog v-model="dialogVisible" :title="dialogType === 'add' ? '新增房间配置' : '编辑房间配置'" width="600px">
...
<script setup>
import { ref } from 'vue'
import { getRoomConfigList, createRoomConfig, updateRoomConfig, deleteRoomConfig } from '@/api/ddz/gameLog'
