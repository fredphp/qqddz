  ...
  <div class="system">
    <el-form ref="form" :model="config" label-width="240px">
      ...
      <el-tabs v-model="activeNames">
        ...
        <el-tab-pane label="广告配置" name="13" class="mt-3.5">
          <el-form-item label="启用广告">
            <el-switch v-model="config.ad.enabled" />
          </el-form-item>

          <el-divider content-position="left">普通场广告奖励配置</el-divider>
          <el-form-item label="奖励豆子数量">
            <el-input-number v-model="config.ad['normal-reward-gold']" :min="0" />
          </el-form-item>
          <el-form-item label="每日最大观看次数">
            <el-input-number v-model="config.ad['normal-daily-max-count']" :min="0" />
          </el-form-item>

          <el-divider content-position="left">竞技场广告奖励配置</el-divider>
          <el-form-item label="奖励竞技币数量">
            <el-input-number v-model="config.ad['arena-reward-coins']" :min="0" />
          </el-form-item>
          <el-form-item label="每日最大观看次数">
            <el-input-number v-model="config.ad['arena-daily-max-count']" :min="0" />
          </el-form-item>

          <el-divider content-position="left">通用配置</el-divider>
          <el-form-item label="广告冷却时间(秒)">
            <el-input-number v-model="config.ad['cooldown-seconds']" :min="0" />
          </el-form-item>

          <el-divider content-position="left">支持的广告SDK</el-divider>
          <el-form-item label="广告SDK">
            <el-select
              v-model="config.ad['supported-sdks']"
              multiple
              placeholder="请选择支持的广告SDK"
              class="w-full"
            >
              <el-option value="csj" label="穿山甲(CSJ)" />
              <el-option value="ylh" label="优量汇(YLH)" />
              <el-option value="ks" label="快手(KS)" />
              <el-option value="bd" label="百度(BD)" />
            </el-select>
          </el-form-item>
          <el-form-item label="默认优先SDK">
            <el-select v-model="config.ad['primary-sdk']" placeholder="请选择默认优先SDK" class="w-full">
              <el-option value="csj" label="穿山甲(CSJ)" />
              <el-option value="ylh" label="优量汇(YLH)" />
              <el-option value="ks" label="快手(KS)" />
              <el-option value="bd" label="百度(BD)" />
          ...
          <el-divider content-position="left">穿山甲广告配置</el-divider>
          <el-form-item label="AppId">
            <el-input
              v-model.trim="config.ad['csj-app-id']"
              placeholder="请输入穿山甲AppId"
            />
          </el-form-item>
          <el-form-item label="激励视频广告位ID">
            <el-input
              v-model.trim="config.ad['csj-rewarded-video-ad-id']"
              placeholder="请输入激励视频广告位ID"
            />
          </el-form-item>

          <el-divider content-position="left">优量汇广告配置</el-divider>
          <el-form-item label="AppId">
            <el-input
              v-model.trim="config.ad['ylh-app-id']"
              placeholder="请输入优量汇AppId"
            />
          </el-form-item>
          <el-form-item label="激励视频广告位ID">
            <el-input
              v-model.trim="config.ad['ylh-rewarded-video-ad-id']"
              placeholder="请输入激励视频广告位ID"
            />
          </el-form-item>

          <el-divider content-position="left">快手广告配置</el-divider>
          <el-form-item label="AppId">
            <el-input
              v-model.trim="config.ad['ks-app-id']"
              placeholder="请输入快手AppId"
            />
          </el-form-item>
          <el-form-item label="激励视频广告位ID">
            <el-input
              v-model.trim="config.ad['ks-rewarded-video-ad-id']"
              placeholder="请输入激励视频广告位ID"
            />
          </el-form-item>

          <el-divider content-position="left">百度广告配置</el-divider>
          <el-form-item label="AppId">
            <el-input
              v-model.trim="config.ad['bd-app-id']"
              placeholder="请输入百度AppId"
            />
          </el-form-item>
          <el-form-item label="激励视频广告位ID">
            <el-input
              v-model.trim="config.ad['bd-rewarded-video-ad-id']"
              placeholder="请输入激励视频广告位ID"
            />
          </el-form-item>
        </el-tab-pane>
...
<script setup>
  ...
  const config = ref({
    ...
    ad: {
      enabled: false,
      'normal-reward-gold': 5000,
      'normal-daily-max-count': 10,
      'arena-reward-coins': 5000,
      'arena-daily-max-count': 10,
      'cooldown-seconds': 30,
      'supported-sdks': [],
      'primary-sdk': ''
    }
