...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
        ...
        entities := []sysModel.SysApi{
                ...
                {ApiGroup: "单页管理", Method: "GET", Path: "/sysUserAgreement/getSysUserAgreementList", Description: "获取单页列表"},
                {ApiGroup: "单页管理", Method: "POST", Path: "/sysUserAgreement/createSysUserAgreement", Description: "创建单页"},
                {ApiGroup: "单页管理", Method: "PUT", Path: "/sysUserAgreement/updateSysUserAgreement", Description: "更新单页"},
                {ApiGroup: "单页管理", Method: "DELETE", Path: "/sysUserAgreement/deleteSysUserAgreement", Description: "删除单页"},
                {ApiGroup: "单页管理", Method: "DELETE", Path: "/sysUserAgreement/deleteSysUserAgreementByIds", Description: "批量删除单页"},
                {ApiGroup: "单页管理", Method: "GET", Path: "/sysUserAgreement/findSysUserAgreement", Description: "获取单页详情"},
                {ApiGroup: "单页管理", Method: "PUT", Path: "/sysUserAgreement/setUserAgreementStatus", Description: "设置单页状态"},
                {ApiGroup: "单页管理", Method: "POST", Path: "/sysUserAgreement/refreshCache", Description: "一键刷新缓存"},
        }
