...
func (sysUserAgreementApi *SysUserAgreementApi) RefreshCache(c *gin.Context) {
        err := sysUserAgreementService.RefreshCache()
        if err != nil {
...
func (sysUserAgreementApi *SysUserAgreementApi) GetHelpArticleList(c *gin.Context) {
        list, err := sysUserAgreementService.GetHelpArticleList()
        if err != nil {
                global.GVA_LOG.Error("获取失败!", zap.Error(err))
                response.FailWithMessage("获取失败:"+err.Error(), c)
                return
...
// GetLatestHelpArticle 获取最新帮助文章（公开接口）
// @Tags SysUserAgreement
// @Summary 获取最新帮助文章
// @accept application/json
// @Produce application/json
...
func (sysUserAgreementApi *SysUserAgreementApi) GetLatestHelpArticle(c *gin.Context) {
        article, err := sysUserAgreementService.GetLatestHelpArticle()
        if err != nil {
                global.GVA_LOG.Error("获取失败!", zap.Error(err))
                response.FailWithMessage("获取失败:"+err.Error(), c)
                return
