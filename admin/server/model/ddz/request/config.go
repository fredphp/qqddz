...
type DDZGameRoomConfigCreate struct {
        ...
        MinArenaCoin      int64   `json:"minArenaCoin"`      // 报名费
...
type DDZGameRoomConfigUpdate struct {
        ...
        MatchRoundDurationAlt int          `json:"match_round_duration"` // 蛇形命名(兼容前端)
        MatchRoundCount    int             `json:"matchRoundCount"`
        MatchRoundCountAlt int             `json:"match_round_count"` // 蛇形命名(兼容前端)
        MaxPlayers         int             `json:"maxPlayers"`
        MaxPlayersAlt      int             `json:"max_players"`         // 蛇形命名(兼容前端)
