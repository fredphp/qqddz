...
type DDZDailyStats struct {
        ...
        TotalGames      int64   `json:"totalGames" gorm:"column:total_games;default:0;comment:总游戏场次"`
        TotalDuration   int64   `json:"totalDuration" gorm:"column:total_duration;default:0;comment:总游戏时长(秒)"`
        AvgGameDuration float64 `json:"avgGameDuration" gorm:"column:avg_game_duration;default:0;comment:平均游戏时长(秒)"`
        MaxOnline       int64   `json:"maxOnline" gorm:"column:max_online;default:0;comment:最高在线人数"`
        TotalOnlineTime int64   `json:"totalOnlineTime" gorm:"column:total_online_time;default:0;comment:总在线时长(秒)"`
        PeakTime        string  `json:"peakTime" gorm:"column:peak_time;comment:高峰时间"`
}
