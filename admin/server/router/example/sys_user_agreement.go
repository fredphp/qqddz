...
func (s *SysUserAgreementRouter) InitSysUserAgreementRouter(Router *gin.RouterGroup, PublicRouter *gin.RouterGroup) {
        ...
        {
                sysUserAgreementRouterWithoutRecord.POST("refreshCache", sysUserAgreementApi.RefreshCache) // 刷新缓存
                sysUserAgreementRouterWithoutRecord.PUT("setUserAgreementStatus", sysUserAgreementApi.SetUserAgreementStatus) // 设置状态
                sysUserAgreementPublicRouter.GET("getHelpArticleList", sysUserAgreementApi.GetHelpArticleList) // 获取帮助文章列表
                sysUserAgreementPublicRouter.GET("getLatestHelpArticle", sysUserAgreementApi.GetLatestHelpArticle) // 获取最新帮助文章
        }
}
