...
func (r *DDZGameLogRouter) InitDDZGameLogRouter(Router *gin.RouterGroup) {
        ...
        ddzGameLogApi := v1.ApiGroupApp.DDZApiGroup.DDZGameLogApi
        {
                ...
                // 游戏房间实例 (ddz_rooms 表)
                ddzGameLogRouter.DELETE("room/delete", ddzGameLogApi.DeleteRoom)
                // 短信验证码
        ...
        }
        {
                ...
                ddzGameLogRouterWithoutRecord.GET("roomConfig/options", ddzGameLogApi.GetGameRoomConfigOptions)
                ddzGameLogRouterWithoutRecord.GET("roomConfig/bg-image-options", ddzGameLogApi.GetBgImageOptions)
                // 游戏房间实例 (ddz_rooms 表)
