...
final class MimeTypeProcessor
{
  ...
  {
    String str1 = retrieveToken(paramString, paramStringPosition).toLowerCase();
    ...
    paramStringPosition.i = (1 + paramStringPosition.i);
    paramStringPosition.i = getNextMeaningfulIndex(paramString, paramStringPosition.i);
    if (paramStringPosition.i >= paramString.length())
      throw new IllegalArgumentException();
    if (paramString.charAt(paramStringPosition.i) == '"');
    for (String str2 = retrieveQuoted(paramString, paramStringPosition); ; str2 = retrieveToken(paramString, paramStringPosition))
    {
      paramMimeType.parameters.put(str1, str2);
      return;
    }
  }
    ...
    implements Cloneable, Serializable
  {
    ...
    void addParameter(String paramString1, String paramString2)
    {
      ...
      {
        return;
        if ((paramString2.charAt(0) == '"') && (paramString2.charAt(-1 + paramString2.length()) == '"'))
          paramString2 = paramString2.substring(1, -2 + paramString2.length());
      }
 ...
 * Qualified Name:     myjava.awt.datatransfer.MimeTypeProcessor
