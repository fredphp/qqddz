...
cc.Class((_cc$Class = {
  ...
  // 【新增】为头像添加圆形遮罩实现圆角效果
  _addCircleMaskToAvatar: function _addCircleMaskToAvatar() {
  ...
  // 帮助内容
  var helpContent = ["🎴 游戏规则", "本游戏为经典斗地主扑克牌游戏", "", "🎮 操作说明", "• 选择房间进入游戏", "• 普通场使用欢乐豆报名", "• 竞技场使用竞技币报名", "", "💰 货币说明", "• 欢乐豆：普通场游戏货币", "• 竞技币：竞技场专用货币", "", "🏆 获胜奖励", "赢得比赛可获得相应货币奖励"];
