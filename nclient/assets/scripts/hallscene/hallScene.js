...
cc.Class({
    ...
    _createPracticeZoneScene: function() {
        ...
        cc.resources.load("practice_zone/practice_zone_ui", cc.SpriteFrame, function(err, spriteFrame) {
            ...
            // UI图片尺寸是640x340，缩放到屏幕的65%大小
            var scale = Math.min(1280 / 640, 720 / 340) * 0.65;
        ...
        // 布局参数 - 根据UI图片布局调整
        // UI图片比例: 640x340，卡片区域约占中间60%宽度
        var cardWidth = 100;    // 每个卡片点击区域宽度
        var cardHeight = 140;   // 每个卡片点击区域高度
        var spacing = 15;       // 卡片间距
