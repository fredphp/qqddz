...
CREATE TABLE `ddz_room_config`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_deleted_at`(`deleted_at` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '房间配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ddz_room_config
-- ----------------------------
INSERT INTO `ddz_room_config` VALUES (1, '新手场', 1, 1, 1, 1000, 50000, 1, 5, 0.0000, 20, 30, 1, 1, '适合新手玩家,底分1,最低1000金币入场', '2026-04-23 07:56:01', '2026-04-23 07:56:01', NULL);
INSERT INTO `ddz_room_config` VALUES (2, '普通场', 2, 2, 1, 50000, 200000, 1, 3, 0.0100, 20, 25, 1, 2, '底分2,适合有一定经验的玩家', '2026-04-23 07:56:01', '2026-04-23 07:56:01', NULL);
INSERT INTO `ddz_room_config` VALUES (3, '高级场', 3, 5, 2, 200000, 1000000, 1, 2, 0.0200, 20, 20, 1, 3, '底分5,倍数2,高手对决', '2026-04-23 07:56:01', '2026-04-23 07:56:01', NULL);
INSERT INTO `ddz_room_config` VALUES (4, '富豪场', 4, 10, 3, 1000000, 5000000, 0, 0, 0.0300, 20, 20, 1, 4, '底分10,倍数3,富豪专属', '2026-04-23 07:56:01', '2026-04-23 07:56:01', NULL);
INSERT INTO `ddz_room_config` VALUES (5, '至尊场', 5, 20, 5, 5000000, 0, 0, 0, 0.0500, 20, 15, 1, 5, '底分20,倍数5,顶级玩家对决,无上限', '2026-04-23 07:56:01', '2026-04-23 07:56:01', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户账户表' ROW_FORMAT = Dynamic;
