  ...
  implements Runnable
{
  ...
  public DragSourceEventProxy(DragSourceContext paramDragSourceContext, int paramInt1, int paramInt2, int paramInt3, Point paramPoint, int paramInt4)
  {
    this.context = paramDragSourceContext;
    this.type = paramInt1;
    this.userAction = paramInt2;
    this.targetActions = paramInt3;
    this.x = paramPoint.x;
    this.y = paramPoint.y;
    this.modifiers = paramInt4;
    this.success = false;
  }

  public DragSourceEventProxy(DragSourceContext paramDragSourceContext, int paramInt1, int paramInt2, boolean paramBoolean, Point paramPoint, int paramInt3)
  {
    this.context = paramDragSourceContext;
    this.type = paramInt1;
    this.userAction = paramInt2;
 ...
 * Qualified Name:     org.apache.harmony.awt.datatransfer.DragSourceEventProxy
