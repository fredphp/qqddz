  ...
  implements Part
{
    ...
    throws MessagingException
  {
    ...
    label150: label156: for (int m = arrayOfAddress3.length; ; m = 0)
    {
      Address[] arrayOfAddress4 = new Address[k + m];
      int n = 0;
      if (arrayOfAddress1 != null)
      {
        System.arraycopy(arrayOfAddress1, 0, arrayOfAddress4, 0, arrayOfAddress1.length);
        n = 0 + arrayOfAddress1.length;
      }
      if (arrayOfAddress2 != null)
      {
        System.arraycopy(arrayOfAddress2, 0, arrayOfAddress4, n, arrayOfAddress2.length);
        n += arrayOfAddress2.length;
      }
      if (arrayOfAddress3 != null)
      {
        System.arraycopy(arrayOfAddress3, 0, arrayOfAddress4, n, arrayOfAddress3.length);
        (n + arrayOfAddress3.length);
      }
