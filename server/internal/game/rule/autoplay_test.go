...
func TestFindSmallestBeatingCards(t *testing.T) {
        ...
        tests := []struct {
                ...
                {
                        name: "New Round: Play smallest single (cannot finish in one hand)",
                        playerHand: []card.Card{
                ...
                {
                        name: "New Round: Finish all cards with a pair",
                        playerHand: []card.Card{
                                {Rank: card.RankJ, Suit: card.Heart},
                                {Rank: card.RankJ, Suit: card.Spade},
                        },
                        opponentHand: nil, // Empty means new round/start
                        expected: []card.Card{
                                {Rank: card.RankJ, Suit: card.Heart},
                ...
                {
                        name: "New Round: Finish all cards with a trio",
                        playerHand: []card.Card{
                                {Rank: card.RankK, Suit: card.Heart},
                                {Rank: card.RankK, Suit: card.Spade},
                                {Rank: card.RankK, Suit: card.Diamond},
                        },
                        opponentHand: nil,
                        expected: []card.Card{
                                {Rank: card.RankK, Suit: card.Heart},
                ...
                {
                        name: "New Round: Finish all cards with a bomb",
                        playerHand: []card.Card{
                                {Rank: card.Rank7, Suit: card.Spade},
                                {Rank: card.Rank7, Suit: card.Heart},
                                {Rank: card.Rank7, Suit: card.Club},
                                {Rank: card.Rank7, Suit: card.Diamond},
                        },
                        opponentHand: nil,
                        expected: []card.Card{
                                {Rank: card.Rank7, Suit: card.Spade},
                ...
                {
                        name: "New Round: Finish all cards with a straight",
                        playerHand: []card.Card{
                                {Rank: card.Rank5, Suit: card.Heart},
                                {Rank: card.Rank6, Suit: card.Heart},
                                {Rank: card.Rank7, Suit: card.Heart},
                                {Rank: card.Rank8, Suit: card.Heart},
                                {Rank: card.Rank9, Suit: card.Heart},
                        },
                        opponentHand: nil,
                        expected: []card.Card{
                                {Rank: card.Rank5, Suit: card.Heart},
                ...
                {
                        name: "New Round: Finish all cards with rocket",
                        playerHand: []card.Card{
                                {Rank: card.RankBlackJoker, Suit: card.Joker},
                                {Rank: card.RankRedJoker, Suit: card.Joker},
                        },
