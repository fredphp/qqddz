...
type PlayerInfo struct {
        ...
        GoldCount     int64                  `protobuf:"varint,8,opt,name=gold_count,json=goldCount,proto3" json:"gold_count,omitempty"`     // 🔧【新增】玩家金币数量
        unknownFields protoimpl.UnknownFields
        sizeCache     protoimpl.SizeCache
}
...
// 🔧【新增】GetGoldCount 获取玩家金币数量
func (x *PlayerInfo) GetGoldCount() int64 {
        if x != nil {
                return x.GoldCount
        }
        return 0
...
var file_internal_protocol_proto_common_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
